...
static const char qt_meta_stringdata_setConsumeMode[] = {
    "setConsumeMode\0\0sendConsumeModeSingnals(QString)\0"
...
void setConsumeMode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        setConsumeMode *_t = static_cast<setConsumeMode *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData setConsumeMode::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject setConsumeMode::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_setConsumeMode,
      qt_meta_data_setConsumeMode, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &setConsumeMode::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_setConsumeMode))
        return static_cast<void*>(const_cast< setConsumeMode*>(this));
